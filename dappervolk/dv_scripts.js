...
window.onload = function () {
	...
	function doCalc() {
		var r = "";
		var time_start = Date("2020-08-20T23:58:00Z"); // 2 mins before rollover on Aug 21 (PDT)
		var time_end = Date("2020-09-04T23:58:00Z"); // 2 mins before rollover on Sep 4 (PDT)
		var tz = "

		r = "<h3>Results</h3><ul><li>Current time is ";
	...
	// Attach the change function & also trigger it with default value
	var e = document.getElementsByClassName("trigger");
	for(var i = 0; i < e.length; i++){
		e[i].onchange = function() { doCalc() };
	}
